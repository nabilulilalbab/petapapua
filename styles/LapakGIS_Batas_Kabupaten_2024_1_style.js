...
var style_LapakGIS_Batas_Kabupaten_2024_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("2024_bukanmakanan2024");
    ...
    if (value >= 31.040000 && value <= 41.840000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 41.840000 && value <= 45.210000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 45.210000 && value <= 58.950000) {
            style = [ new ol.style.Style({
